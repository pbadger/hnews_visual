...
function setup_themes(){
  ...
  themes.google_glass.keywords = ['google','glass','glasses','augmented','reality','developers','resolution','wearing'];
  ...
  themes.servers.keywords = ['server','rails','heroku','hosting','host','php','postgres','mongo','mongodb']
